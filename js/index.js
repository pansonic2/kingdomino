...
$("#morebuttons").on("click", morebtn)
  ...
  $("body").append("<form name = crowns>crowns <select><option>1<option>2<option>3<option>4<option>5<option>6<option>7<option>8<option>9</option></form>");
  $("body").append("<form name = tiles>tiles <select><option>1<option>2<option>3<option>4<option>5<option>6<option>7<option>8<option>9</option></form>");
